...
<body class="antialiased font-semibold">
    ...
    @endif
    @if ($errors->any())
        <div id="alert-error" class="fixed flex bottom-2 right-2 p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50"
            role="alert">
            <div>
                ...
                <ul class="mt-1.5 list-disc text-sm ms-1 list-inside">
