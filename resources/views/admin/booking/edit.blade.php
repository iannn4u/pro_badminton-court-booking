    ...
    <form action="/admin/booking/{{ $booking->id_booking }}" method="post" class="max-w-xl mt-5 md:mt-10 space-y-5">
        ...
        <div class="relative">
            ...
            <input type="text" id="name_booking" name="name_booking"
                value="{{ $booking->name_booking }}" readonly
        ...
        <div>
            ...
            <input type="text" id="phoneNumber" name="phoneNumber" value="{{ $booking->pelanggan->phoneNumber }}" autocomplete="off" readonly
                class="block w-full p-2 text-slate-900 border border-slate-500 rounded-lg bg-white text-xs focus:ring-slate-500 focus:border-slate-500">
        </div>
        <div class="w-min">
        ...
        <div>
            ...
            <div id="lapangan-options" class="pointer-events-none opacity-50">
                @if (!$courts->isEmpty())
        ...
        <div class="sm:flex-row flex-col">
            ...
            <ul id="cardSlot" class="grid w-full grid-cols-3 gap-2 mt-2 px-5 opacity-50">
                @for ($i = $incrementOpen; $i < $incrementClose; $i++)
                    <li>
                        <input type="radio" id="{{ $i }}.00 - {{ $i + 1 }}.00" name="time_booking"
