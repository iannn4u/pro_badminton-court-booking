    ...
    <section class="bg-white shadow-md p-10 w-[400px]">
        ...
        <form action="/admin/login" method="post">
            ...
            <div class="flex flex-col mb-3">
                <label for="username_email" class="mb-1">Username / Email address</label>
                <input type="text" name="username_email" id="username_email"
                    class="py-1 rounded-md focus:ring-slate-700 focus:border-slate-700" value="{{ old("username_email") }}">
            </div>
            <div class="flex flex-col mb-3">
