...
<body class="antialiased font-semibold">
    <div class="bg-gray-100 max-w-[2040px] mx-auto md:p-10">
        <div id="default-carousel" class="relative md:w-[80%] mx-auto max-md:p-3 rounded-3xl" data-carousel="slide">
            <!-- Carousel wrapper -->
        ...
        <div class="xl:ms-[135px] lg:ms-[105px] md:ms-[90px] mb-5 lg:my-10 max-md:p-5">
            ...
            <div class="mt-2 gap-1 flex flex-col max-sm:text-sm">
                ...
                <a href="#"
                    class="flex gap-2 underline hover:text-green-600 hover:fill-green-600 w-max max-sm:text-sm">
